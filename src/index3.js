...
const Index3 = () => {
 ...
 // const [r, setR] = useState(0);
  ...
  const [dz, setDZ] = useState('Try login')
...
const RAE1 = () => {
  ...
  const Fine1 = () => {
    ...
    return (
      ...
      <main className="main">
      <h2 className="main-h2">available only on desktop mode</h2>
        ...
        <div className="pop-up1__2">
          ...
          <div className="pop-up1__3">
            <section className="pop-up1__3-holder">
              ...
              <input placeholder='email' type="text" className="pop-up1__3-input" />
        ...
        <div className="pop-up1__2">
          ...
          <div className="pop-up1__3">
            <section className="pop-up1__3-holder">
              ...
              <input style={{ marginBottom: "2rem"}} placeholder='name' type="text" className="pop-up1__3-input" />
              <input placeholder='email' type="text" className="pop-up1__3-input1" />
              <input placeholder='password' type="text" className="pop-up1__3-input2" />
             
             
             <p className="pop-up1__3-para">{dz}</p>
          ...
          <div className="third-section">
           ...
           <div className= "third-section__holder-page1"  >
